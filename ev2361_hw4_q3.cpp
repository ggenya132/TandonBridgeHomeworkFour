...
// O log(N) 🤓
// log after invocation to create correct binary structure (Last In First Out, AKA, Stack)
// constraint of not using strings or array produces non idiomatic code ¯\_(ツ)_/¯ 
